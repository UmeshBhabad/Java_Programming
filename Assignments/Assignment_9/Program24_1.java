...
class Arrayx
{
    public int Maximum(int Arr[], int iLength)                  // Function defination
    {
...
class Program24_1
{
    public static void main(String A[])                         // Main Method
    {
        ...
        iRet = aobj.Maximum(Arr, iSize);                        // Function call

        System.out.println("Max element is "+iRet);             // Display Output
