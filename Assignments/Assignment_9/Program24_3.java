// Accept N numbers from user and return the difference between the Largest and Smallest number.
...
class Program24_3
{
    public static void main(String A[])                                             // Main Method
    {
        ...
        System.out.println("Difference between Max and Min element is "+iRet);      // Display Output
