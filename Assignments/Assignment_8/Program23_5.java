...
class Arrayx
{
    public int Product(int Arr[], int iLength)                              // Function defination
    {
...
class Program23_5
{
    public static void main(String A[])                                     // Main Method
    {
        ...
        iRet = aobj.Product(Arr, iSize);                                    // Function call

        System.out.println("Product of odd elements : " +iRet);             // Display output
