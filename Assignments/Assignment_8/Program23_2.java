// Accept N numbers from user and accept one another number as No, return the index of first occurrence of that No.
...
class Arrayx
{
    public int FirstOcc(int Arr[], int iLength, int iNo)        // Function defination
    {
...
class Program23_2
{
    public static void main(String A[])                         // Main Method
    {
        ...
        iRet = aobj.FirstOcc(Arr, iSize, iValue);               // Function call
