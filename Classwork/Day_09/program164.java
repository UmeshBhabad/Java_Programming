...
class Pattern
{
    public void Display(int iRow, int iCol)                         // Function Defination
    {
        ...
        {
            for(j = 1; j <= iCol; j++)                              // Nested For loop
            {
                System.out.print("*\t");
            }
            System.out.println();
...
class program164
{
    public static void main(String []args)                          // Main Method
    {
        ...
        System.out.println("Enter the Number of Rows : ");          // Accept NO. of Rows
        iValue1 = sobj.nextInt();

        System.out.println("Enter the Number of Columns : ");       // Accept NO. of Columns
